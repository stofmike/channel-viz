(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'A8fC0BnBAs6dgxAqDF5sjLpOr7VKGLv49PUUSQ32nABRgLTa', // Unique master Xively API key to be used as a default
		defaultFeeds	= ['79508344'], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Application Name', // Replaces Xively logo in the header
		dataDuration	= '6days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
